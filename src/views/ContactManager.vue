    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          minima corrupti totam quisquam reprehenderit ducimus temporibus
          blanditiis deleniti magnam repellendus assumenda consequatur ab et,
          reiciendis beatae. Excepturi, provident voluptate?
        </p>
        <form>
          <div class="row">
            <div class="col-md-6">
  ...
  <div class="container mt-3" v-if="contacts.length > 0">
    <div class="row">
      <div class="col-md-6" v-for="contact of contacts" :key="contact">
        <div
          class="card my-2 list-group-item list-group-item-secondary shadow-lg"
        >
          <div class="card-body">
