<template>
  <div class="container mt-3">
    <div class="row">
      <div class="col">
        <p class="h3 text-dark fw-bold">Edit contact</p>
        <p class="fst-italic">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat quae,
          vitae optio a deleniti voluptatem eum, blanditiis veniam dignissimos,
          delectus voluptate praesentium? Repellat, amet! Minus itaque numquam
          minima cupiditate odio!
        </p>
      </div>
    </div>
  </div>
