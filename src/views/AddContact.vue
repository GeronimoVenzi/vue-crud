<template>
  <div class="container mt-3">
    <div class="row">
      <div class="col">
        <p class="h3 text-dark fw-bold">Add contact</p>
        <p class="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos autem rem magnam quisquam eius? Accusamus aliquid at, odit assumenda quae exercitationem, iure minus nesciunt labore impedit libero tenetur, ducimus eius.</p>
      </div>
    </div>
  </div>
  <div class="container mt-3">
